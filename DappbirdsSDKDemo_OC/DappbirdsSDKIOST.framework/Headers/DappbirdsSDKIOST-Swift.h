...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DappbirdsSDKIOST",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC16DappbirdsSDKIOST16IOSTAccountModel")
@interface IOSTAccountModel : NSObject
...
@class ResourceBaseVC;
@class IOST_Account;

SWIFT_CLASS("_TtC16DappbirdsSDKIOST16IOSTChainManager")
@interface IOSTChainManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IOSTChainManager * _Nonnull shared;)
+ (IOSTChainManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic) BOOL debuggerMode;
- (void)creatIOSTAccountWithPrivateKey:(NSString * _Nonnull)privateKey name:(NSString * _Nonnull)name pwd:(NSString * _Nonnull)pwd reg_code:(NSString * _Nonnull)reg_code app_id:(NSString * _Nonnull)app_id openid:(NSString * _Nonnull)openid completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable, NSArray<NSString *> * _Nullable, IOSTAccountModel * _Nullable))completion;
- (ResourceBaseVC * _Nonnull)presentIOSTExchangeVCWithAddress:(NSString * _Nonnull)address privateStr:(NSString * _Nonnull)privateStr SWIFT_WARN_UNUSED_RESULT;
- (void)sendIOSTContractFromAddress:(NSString * _Nonnull)fromAddress privateStr:(NSString * _Nonnull)privateStr amount:(NSInteger)amount orderNumber:(NSString * _Nonnull)orderNumber contractToken:(NSString * _Nonnull)contractToken completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable, NSString * _Nullable))completion;
- (void)getIOSTAccountInfoWithAddress:(NSString * _Nonnull)address completion:(void (^ _Nonnull)(BOOL, IOST_Account * _Nullable))completion;
- (void)creatNewPocketByDappbirdsWithChain_type:(NSString * _Nonnull)chain_type wallet_address:(NSString * _Nonnull)wallet_address pubID:(NSString * _Nonnull)pubID reg_code:(NSString * _Nonnull)reg_code app_id:(NSString * _Nonnull)app_id openid:(NSString * _Nonnull)openid completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC16DappbirdsSDKIOST12IOST_Account")
@interface IOST_Account : NSObject
@property (nonatomic, copy) NSString * _Null_unspecified balanceStr;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC16DappbirdsSDKIOST14ResourceBaseVC")
@interface ResourceBaseVC : UIViewController <UIScrollViewDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC16DappbirdsSDKIOST15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(DappbirdsSDKIOST)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DappbirdsSDKIOST)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DappbirdsSDKIOST)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DappbirdsSDKIOST)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DappbirdsSDKIOST)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC16DappbirdsSDKIOST12TaskDelegate")
